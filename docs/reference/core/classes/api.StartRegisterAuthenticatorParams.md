...
[toRaw](../api.StartRegisterAuthenticatorParams#toraw) on any properties that
...
[toRaw](../api.StartRegisterAuthenticatorParams#toraw). The base implementation
...
[\_fromRaw](../api.StartRegisterAuthenticatorParams#_fromraw) method to
...
versions. Use [\_toRaw](../api.StartRegisterAuthenticatorParams#_toraw) for
