---
title: "Class: StartRegisterAuthenticatorParams"
linkTitle: "StartRegisterAuthenticatorParams"
slug: "api.StartRegisterAuthenticatorParams"
---

[api](../../modules/api).StartRegisterAuthenticatorParams
...
• **new StartRegisterAuthenticatorParams**(`props?`)

#### Parameters

| Name     | Type                                                                                      |
| :------- | :---------------------------------------------------------------------------------------- |
| `props?` | `Partial`<[`StartRegisterAuthenticatorParams`](../api.StartRegisterAuthenticatorParams)\> |
...
[core/src/api.ts:90](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L90)
...
[core/src/api.ts:85](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L85)
...
[core/src/api.ts:88](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L88)
...
[core/src/api.ts:83](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L83)
...
[core/src/api.ts:81](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L81)
...
[toRaw](api.StartRegisterAuthenticatorParams.md#toraw) on any properties that
...
[toRaw](api.StartRegisterAuthenticatorParams.md#toraw). The base implementation
...
[\_fromRaw](api.StartRegisterAuthenticatorParams.md#_fromraw) method to
...
versions. Use [\_toRaw](api.StartRegisterAuthenticatorParams.md#_toraw) for
