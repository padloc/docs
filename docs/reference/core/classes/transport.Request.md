...
[[exlude]] array and calls [toRaw](../transport.Request#toraw) on any properties
...
[toRaw](../transport.Request#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../transport.Request#_fromraw) method to
...
versions. Use [\_toRaw](../transport.Request#_toraw) for subclass-specific
behavior.
