...
[[exlude]] array and calls [toRaw](../api.GetAttachmentParams#toraw) on any
...
[toRaw](../api.GetAttachmentParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.GetAttachmentParams#_fromraw)
...
versions. Use [\_toRaw](../api.GetAttachmentParams#_toraw) for subclass-specific
behavior.
