---
title: "Class: GetAttachmentParams"
linkTitle: "GetAttachmentParams"
slug: "api.GetAttachmentParams"
---

[api](../../modules/api).GetAttachmentParams

Parameters for fetching an [Attachment](../attachment.Attachment)
...
[[exlude]] array and calls [toRaw](api.GetAttachmentParams.md#toraw) on any
...
▸ **clone**(): [`GetAttachmentParams`](../api.GetAttachmentParams)
...
▸ **fromBytes**(`bytes`): [`GetAttachmentParams`](../api.GetAttachmentParams)
...
▸ **fromJSON**(`json`): [`GetAttachmentParams`](../api.GetAttachmentParams)
...
▸ **fromRaw**(`raw`): [`GetAttachmentParams`](../api.GetAttachmentParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](api.GetAttachmentParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](api.GetAttachmentParams.md#_fromraw)
...
versions. Use [\_toRaw](api.GetAttachmentParams.md#_toraw) for subclass-specific
behavior.
