---
title: "Class: GetInviteParams"
linkTitle: "GetInviteParams"
slug: "api.GetInviteParams"
---

[api](../../modules/api).GetInviteParams

Parameters for fetching an [Invite](../invite.Invite)
...
• **new GetInviteParams**(`props?`)

#### Parameters

| Name     | Type                                                    |
| :------- | :------------------------------------------------------ |
| `props?` | `Partial`<[`GetInviteParams`](../api.GetInviteParams)\> |
...
[core/src/api.ts:289](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L289)
...
[core/src/api.ts:287](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L287)
...
[core/src/api.ts:284](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L284)
...
[[exlude]] array and calls [toRaw](api.GetInviteParams.md#toraw) on any
...
▸ **clone**(): [`GetInviteParams`](../api.GetInviteParams)
...
▸ **fromBytes**(`bytes`): [`GetInviteParams`](../api.GetInviteParams)
...
▸ **fromJSON**(`json`): [`GetInviteParams`](../api.GetInviteParams)
...
▸ **fromRaw**(`raw`): [`GetInviteParams`](../api.GetInviteParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](api.GetInviteParams.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](api.GetInviteParams.md#_fromraw) method
...
versions. Use [\_toRaw](api.GetInviteParams.md#_toraw) for subclass-specific
behavior.
