...
[[exlude]] array and calls [toRaw](../api.GetInviteParams#toraw) on any
...
[toRaw](../api.GetInviteParams#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../api.GetInviteParams#_fromraw) method
...
versions. Use [\_toRaw](../api.GetInviteParams#_toraw) for subclass-specific
behavior.
