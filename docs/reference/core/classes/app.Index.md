...
[[exlude]] array and calls [toRaw](../app.Index#toraw) on any properties that
...
[toRaw](../app.Index#toraw). The base implementation blindly copies over values
...
version. Use the protected [\_fromRaw](../app.Index#_fromraw) method to
...
▸ **fuzzyMatchHost**(`host`): `Promise`<`number`\>
...
versions. Use [\_toRaw](../app.Index#_toraw) for subclass-specific behavior.
