...
[[exlude]] array and calls [toRaw](../provisioning.Feature#toraw) on any
...
▸ **fromBytes**(`bytes`): [`Feature`](../provisioning.Feature)
...
[toRaw](../provisioning.Feature#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../provisioning.Feature#_fromraw) method
...
versions. Use [\_toRaw](../provisioning.Feature#_toraw) for subclass-specific
behavior.
