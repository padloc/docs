...
[[exlude]] array and calls [toRaw](../crypto.HMACKeyParams#toraw) on any
...
[toRaw](../crypto.HMACKeyParams#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../crypto.HMACKeyParams#_fromraw) method
...
versions. Use [\_toRaw](../crypto.HMACKeyParams#_toraw) for subclass-specific
behavior.
