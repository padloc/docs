---
title: "Class: AccountQuota"
linkTitle: "AccountQuota"
slug: "provisioning.AccountQuota"
---

[provisioning](../../modules/provisioning).AccountQuota
...
• **new AccountQuota**(`vals?`)

#### Parameters

| Name   | Type                                                       |
| :----- | :--------------------------------------------------------- |
| `vals` | `Partial`<[`AccountQuota`](../provisioning.AccountQuota)\> |
...
[core/src/provisioning.ts:30](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L30)
...
[core/src/provisioning.ts:36](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L36)
...
[core/src/provisioning.ts:35](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L35)
...
[[exlude]] array and calls [toRaw](provisioning.AccountQuota.md#toraw) on any
...
▸ **clone**(): [`AccountQuota`](../provisioning.AccountQuota)
...
▸ **fromBytes**(`bytes`): [`AccountQuota`](../provisioning.AccountQuota)
...
▸ **fromJSON**(`json`): [`AccountQuota`](../provisioning.AccountQuota)
...
▸ **fromRaw**(`raw`): [`AccountQuota`](../provisioning.AccountQuota)

Restores propertiers from a raw object of the same form generated by
[toRaw](provisioning.AccountQuota.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](provisioning.AccountQuota.md#_fromraw)
...
versions. Use [\_toRaw](provisioning.AccountQuota.md#_toraw) for
