...
[[exlude]] array and calls [toRaw](../v3_compat.RequestMFACodeParams#toraw) on
...
[toRaw](../v3_compat.RequestMFACodeParams#toraw). The base implementation
...
[\_fromRaw](../v3_compat.RequestMFACodeParams#_fromraw) method to implement
...
versions. Use [\_toRaw](../v3_compat.RequestMFACodeParams#_toraw) for
subclass-specific behavior.
