...
[[exlude]] array and calls [toRaw](org.OrgDirectorySettings.md#toraw) on any
...
[toRaw](org.OrgDirectorySettings.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](org.OrgDirectorySettings.md#_fromraw)
...
versions. Use [\_toRaw](org.OrgDirectorySettings.md#_toraw) for
