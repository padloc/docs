---
title: "Class: StartCreateSessionParams"
linkTitle: "StartCreateSessionParams"
slug: "api.StartCreateSessionParams"
---

[api](../../modules/api).StartCreateSessionParams
...
• **new StartCreateSessionParams**(`props?`)

#### Parameters

| Name     | Type                                                                      |
| :------- | :------------------------------------------------------------------------ |
| `props?` | `Partial`<[`StartCreateSessionParams`](../api.StartCreateSessionParams)\> |
...
[core/src/api.ts:224](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L224)
...
[core/src/api.ts:222](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L222)
...
[core/src/api.ts:217](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L217)
...
[[exlude]] array and calls [toRaw](api.StartCreateSessionParams.md#toraw) on any
...
▸ **clone**(): [`StartCreateSessionParams`](../api.StartCreateSessionParams)
...
[toRaw](api.StartCreateSessionParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](api.StartCreateSessionParams.md#_fromraw)
...
versions. Use [\_toRaw](api.StartCreateSessionParams.md#_toraw) for
