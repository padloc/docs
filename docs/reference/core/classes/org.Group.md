...
[[exlude]] array and calls [toRaw](../org.Group#toraw) on any properties that
...
[toRaw](../org.Group#toraw). The base implementation blindly copies over values
...
version. Use the protected [\_fromRaw](../org.Group#_fromraw) method to
...
versions. Use [\_toRaw](../org.Group#_toraw) for subclass-specific behavior.
