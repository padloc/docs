...
[org](../../modules/org).Group

A group of members, used to manage [Vault](../vault.Vault) access for multiple
members at once.
...
[core/src/org.ts:128](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L128)
...
• **members**: { `accountId?`: `string` ; `email`: `string` }[] = `[]`

members assigned to this group

#### Defined in

[core/src/org.ts:136](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L136)
...
[core/src/org.ts:134](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L134)
...
[Vault](../vault.Vault)s assigned to this group

#### Defined in

[core/src/org.ts:138](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L138)
...
[[exlude]] array and calls [toRaw](org.Group.md#toraw) on any properties that
...
▸ **fromBytes**(`bytes`): [`Group`](../org.Group)
...
▸ **fromRaw**(`raw`): [`Group`](../org.Group)

Restores propertiers from a raw object of the same form generated by
[toRaw](org.Group.md#toraw). The base implementation blindly copies over values
...
version. Use the protected [\_fromRaw](org.Group.md#_fromraw) method to
...
versions. Use [\_toRaw](org.Group.md#_toraw) for subclass-specific behavior.
