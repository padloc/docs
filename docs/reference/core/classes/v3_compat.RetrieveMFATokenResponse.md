...
[[exlude]] array and calls [toRaw](../v3_compat.RetrieveMFATokenResponse#toraw)
...
[toRaw](../v3_compat.RetrieveMFATokenResponse#toraw). The base implementation
...
[\_fromRaw](../v3_compat.RetrieveMFATokenResponse#_fromraw) method to implement
...
versions. Use [\_toRaw](../v3_compat.RetrieveMFATokenResponse#_toraw) for
subclass-specific behavior.
