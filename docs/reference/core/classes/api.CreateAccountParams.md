...
[API.createAccount](../api.API#createaccount).
...
[API.completeAuthRequest](../api.API#completeauthrequest).
...
The corresponding [InviteID](../modules/invite#inviteid) and
[OrgID](../modules/org#orgid) if signup was initiated through an invite link.
...
[[exlude]] array and calls [toRaw](../api.CreateAccountParams#toraw) on any
...
[toRaw](../api.CreateAccountParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.CreateAccountParams#_fromraw)
...
versions. Use [\_toRaw](../api.CreateAccountParams#_toraw) for subclass-specific
behavior.
