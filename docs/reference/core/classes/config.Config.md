...
[[exlude]] array and calls [toRaw](../config.Config#toraw) on any properties
...
[toRaw](../config.Config#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../config.Config#_fromraw) method to
...
versions. Use [\_toRaw](../config.Config#_toraw) for subclass-specific behavior.
