...
[[exlude]] array and calls [toRaw](transport.Response.md#toraw) on any
...
[toRaw](transport.Response.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](transport.Response.md#_fromraw) method to
...
versions. Use [\_toRaw](transport.Response.md#_toraw) for subclass-specific
behavior.
