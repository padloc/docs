...
[[exlude]] array and calls [toRaw](storage.Storable.md#toraw) on any properties
...
[toRaw](storage.Storable.md#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](storage.Storable.md#_fromraw) method to
...
versions. Use [\_toRaw](storage.Storable.md#_toraw) for subclass-specific
behavior.
