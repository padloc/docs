...
[[exlude]] array and calls [toRaw](../account.AccountSecrets#toraw) on any
...
[toRaw](../account.AccountSecrets#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../account.AccountSecrets#_fromraw)
...
versions. Use [\_toRaw](../account.AccountSecrets#_toraw) for subclass-specific
behavior.
