...
[[exlude]] array and calls [toRaw](../crypto.AESKeyParams#toraw) on any
...
[toRaw](../crypto.AESKeyParams#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../crypto.AESKeyParams#_fromraw) method
...
versions. Use [\_toRaw](../crypto.AESKeyParams#_toraw) for subclass-specific
behavior.
