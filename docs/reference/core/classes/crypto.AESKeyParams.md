---
title: "Class: AESKeyParams"
linkTitle: "AESKeyParams"
slug: "crypto.AESKeyParams"
---

[crypto](../../modules/crypto).AESKeyParams
...
[core/src/crypto.ts:35](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L35)
...
[core/src/crypto.ts:36](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L36)
...
[[exlude]] array and calls [toRaw](crypto.AESKeyParams.md#toraw) on any
...
▸ **clone**(): [`AESKeyParams`](../crypto.AESKeyParams)
...
▸ **fromBytes**(`bytes`): [`AESKeyParams`](../crypto.AESKeyParams)
...
▸ **fromJSON**(`json`): [`AESKeyParams`](../crypto.AESKeyParams)
...
▸ **fromRaw**(`raw`): [`AESKeyParams`](../crypto.AESKeyParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](crypto.AESKeyParams.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](crypto.AESKeyParams.md#_fromraw) method
...
versions. Use [\_toRaw](crypto.AESKeyParams.md#_toraw) for subclass-specific
behavior.
...
[core/src/crypto.ts:38](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L38)
