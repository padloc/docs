...
[API.recoverAccount](../api.API#recoveraccount)
...
[[exlude]] array and calls [toRaw](../api.RecoverAccountParams#toraw) on any
...
[toRaw](../api.RecoverAccountParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.RecoverAccountParams#_fromraw)
...
versions. Use [\_toRaw](../api.RecoverAccountParams#_toraw) for
