...
[[exlude]] array and calls [toRaw](../app.Settings#toraw) on any properties that
...
[toRaw](../app.Settings#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../app.Settings#_fromraw) method to
...
versions. Use [\_toRaw](../app.Settings#_toraw) for subclass-specific behavior.
