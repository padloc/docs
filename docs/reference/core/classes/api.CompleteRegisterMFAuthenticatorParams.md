...
[toRaw](../api.CompleteRegisterMFAuthenticatorParams#toraw) on any properties
...
[toRaw](../api.CompleteRegisterMFAuthenticatorParams#toraw). The base
...
[\_fromRaw](../api.CompleteRegisterMFAuthenticatorParams#_fromraw) method to
...
versions. Use [\_toRaw](../api.CompleteRegisterMFAuthenticatorParams#_toraw) for
