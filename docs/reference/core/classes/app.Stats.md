...
[[exlude]] array and calls [toRaw](../app.Stats#toraw) on any properties that
...
[toRaw](../app.Stats#toraw). The base implementation blindly copies over values
...
version. Use the protected [\_fromRaw](../app.Stats#_fromraw) method to
...
versions. Use [\_toRaw](../app.Stats#_toraw) for subclass-specific behavior.
