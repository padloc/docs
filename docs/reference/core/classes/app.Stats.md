...
[core/src/app.ts:41](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/app.ts#L41)
...
[[exlude]] array and calls [toRaw](app.Stats.md#toraw) on any properties that
...
▸ **fromBytes**(`bytes`): [`Stats`](../app.Stats)
...
▸ **fromRaw**(`raw`): [`Stats`](../app.Stats)

Restores propertiers from a raw object of the same form generated by
[toRaw](app.Stats.md#toraw). The base implementation blindly copies over values
...
version. Use the protected [\_fromRaw](app.Stats.md#_fromraw) method to
...
versions. Use [\_toRaw](app.Stats.md#_toraw) for subclass-specific behavior.
