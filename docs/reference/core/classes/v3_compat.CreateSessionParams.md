...
[[exlude]] array and calls [toRaw](../v3_compat.CreateSessionParams#toraw) on
...
[toRaw](../v3_compat.CreateSessionParams#toraw). The base implementation blindly
...
[\_fromRaw](../v3_compat.CreateSessionParams#_fromraw) method to implement
...
versions. Use [\_toRaw](../v3_compat.CreateSessionParams#_toraw) for
subclass-specific behavior.
