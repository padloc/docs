...
[[exlude]] array and calls [toRaw](../crypto.HMACParams#toraw) on any properties
...
[toRaw](../crypto.HMACParams#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../crypto.HMACParams#_fromraw) method to
...
versions. Use [\_toRaw](../crypto.HMACParams#_toraw) for subclass-specific
behavior.
