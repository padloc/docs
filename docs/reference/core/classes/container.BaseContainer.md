...
the [unlock](container.BaseContainer.md#unlock) method and may likely also want
to augment [lock](container.BaseContainer.md#lock),
[validate](container.BaseContainer.md#validate),
[\_fromRaw](container.BaseContainer.md#_fromraw) and
[\_toRaw](container.BaseContainer.md#_toraw).
...
[unlock](container.BaseContainer.md#unlock) method.
...
[[exlude]] array and calls [toRaw](container.BaseContainer.md#toraw) on any
...
[toRaw](container.BaseContainer.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](container.BaseContainer.md#_fromraw)
...
[getData](container.BaseContainer.md#getdata) until the container is unlocked
...
versions. Use [\_toRaw](container.BaseContainer.md#_toraw) for subclass-specific
behavior.
...
[getData](container.BaseContainer.md#getdata). The type of **secret** provided
