---
title: "Class: RSAEncryptionParams"
linkTitle: "RSAEncryptionParams"
slug: "crypto.RSAEncryptionParams"
---

[crypto](../../modules/crypto).RSAEncryptionParams
...
[core/src/crypto.ts:97](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L97)
...
[core/src/crypto.ts:98](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L98)
...
[[exlude]] array and calls [toRaw](crypto.RSAEncryptionParams.md#toraw) on any
...
▸ **clone**(): [`RSAEncryptionParams`](../crypto.RSAEncryptionParams)
...
▸ **fromBytes**(`bytes`): [`RSAEncryptionParams`](../crypto.RSAEncryptionParams)
...
▸ **fromJSON**(`json`): [`RSAEncryptionParams`](../crypto.RSAEncryptionParams)
...
▸ **fromRaw**(`raw`): [`RSAEncryptionParams`](../crypto.RSAEncryptionParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](crypto.RSAEncryptionParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](crypto.RSAEncryptionParams.md#_fromraw)
...
versions. Use [\_toRaw](crypto.RSAEncryptionParams.md#_toraw) for
...
[core/src/crypto.ts:100](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L100)
