...
[[exlude]] array and calls [toRaw](../session.SessionInfo#toraw) on any
...
[toRaw](../session.SessionInfo#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../session.SessionInfo#_fromraw) method
...
versions. Use [\_toRaw](../session.SessionInfo#_toraw) for subclass-specific
behavior.
