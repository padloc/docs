...
Represents an [Account](../account.Account)s membership to an [Org](../org.Org)
...
signature used by the member to verify [Org.id](../org.Org#id) and
...
public key of the corresponding [Account](../account.Account)
...
signature used by other members to verify [id](../org.OrgMember#id),
[email](../org.OrgMember#email) and [publicKey](../org.OrgMember#publickey)
...
[[exlude]] array and calls [toRaw](../org.OrgMember#toraw) on any properties
...
[toRaw](../org.OrgMember#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../org.OrgMember#_fromraw) method to
...
versions. Use [\_toRaw](../org.OrgMember#_toraw) for subclass-specific behavior.
