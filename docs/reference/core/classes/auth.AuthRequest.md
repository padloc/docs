...
[[exlude]] array and calls [toRaw](../auth.AuthRequest#toraw) on any properties
...
[toRaw](../auth.AuthRequest#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../auth.AuthRequest#_fromraw) method to
...
versions. Use [\_toRaw](../auth.AuthRequest#_toraw) for subclass-specific
behavior.
