...
[[exlude]] array and calls [toRaw](provisioning.OrgQuota.md#toraw) on any
...
[toRaw](provisioning.OrgQuota.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](provisioning.OrgQuota.md#_fromraw) method
...
versions. Use [\_toRaw](provisioning.OrgQuota.md#_toraw) for subclass-specific
behavior.
