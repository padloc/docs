---
title: "Class: HashParams"
linkTitle: "HashParams"
slug: "crypto.HashParams"
---

[crypto](../../modules/crypto).HashParams
...
• **new HashParams**(`props?`)

#### Parameters

| Name     | Type                                             |
| :------- | :----------------------------------------------- |
| `props?` | `Partial`<[`HashParams`](../crypto.HashParams)\> |
...
[core/src/crypto.ts:133](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L133)
...
[core/src/crypto.ts:131](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L131)
...
[[exlude]] array and calls [toRaw](crypto.HashParams.md#toraw) on any properties
...
▸ **clone**(): [`HashParams`](../crypto.HashParams)
...
▸ **fromBytes**(`bytes`): [`HashParams`](../crypto.HashParams)
...
▸ **fromJSON**(`json`): [`HashParams`](../crypto.HashParams)
...
▸ **fromRaw**(`raw`): [`HashParams`](../crypto.HashParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](crypto.HashParams.md#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](crypto.HashParams.md#_fromraw) method to
...
versions. Use [\_toRaw](crypto.HashParams.md#_toraw) for subclass-specific
behavior.
...
[core/src/crypto.ts:138](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L138)
