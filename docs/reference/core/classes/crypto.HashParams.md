...
[[exlude]] array and calls [toRaw](../crypto.HashParams#toraw) on any properties
...
[toRaw](../crypto.HashParams#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../crypto.HashParams#_fromraw) method to
...
versions. Use [\_toRaw](../crypto.HashParams#_toraw) for subclass-specific
behavior.
