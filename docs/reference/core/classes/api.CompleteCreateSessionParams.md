...
[[exlude]] array and calls [toRaw](api.CompleteCreateSessionParams.md#toraw) on
...
[toRaw](api.CompleteCreateSessionParams.md#toraw). The base implementation
...
[\_fromRaw](api.CompleteCreateSessionParams.md#_fromraw) method to implement
...
versions. Use [\_toRaw](api.CompleteCreateSessionParams.md#_toraw) for
subclass-specific behavior.
