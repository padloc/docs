---
title: "Class: StartRegisterAuthenticatorResponse"
linkTitle: "StartRegisterAuthenticatorResponse"
slug: "api.StartRegisterAuthenticatorResponse"
---

[api](../../modules/api).StartRegisterAuthenticatorResponse
...
• **new StartRegisterAuthenticatorResponse**(`props?`)

#### Parameters

| Name     | Type                                                                                          |
| :------- | :-------------------------------------------------------------------------------------------- |
| `props?` | `Partial`<[`StartRegisterAuthenticatorResponse`](../api.StartRegisterAuthenticatorResponse)\> |
...
[core/src/api.ts:103](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L103)
...
[core/src/api.ts:101](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L101)
...
[core/src/api.ts:97](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L97)
...
[core/src/api.ts:99](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L99)
...
[toRaw](api.StartRegisterAuthenticatorResponse.md#toraw) on any properties that
...
[toRaw](api.StartRegisterAuthenticatorResponse.md#toraw). The base
...
[\_fromRaw](api.StartRegisterAuthenticatorResponse.md#_fromraw) method to
...
versions. Use [\_toRaw](api.StartRegisterAuthenticatorResponse.md#_toraw) for
