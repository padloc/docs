...
[toRaw](../api.StartRegisterAuthenticatorResponse#toraw) on any properties that
...
[toRaw](../api.StartRegisterAuthenticatorResponse#toraw). The base
...
[\_fromRaw](../api.StartRegisterAuthenticatorResponse#_fromraw) method to
...
versions. Use [\_toRaw](../api.StartRegisterAuthenticatorResponse#_toraw) for
