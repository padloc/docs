...
[[exlude]] array and calls [toRaw](../org.OrgSecrets#toraw) on any properties
...
[toRaw](../org.OrgSecrets#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../org.OrgSecrets#_fromraw) method to
...
versions. Use [\_toRaw](../org.OrgSecrets#_toraw) for subclass-specific
behavior.
