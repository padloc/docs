---
title: "Class: OrgSecrets"
linkTitle: "OrgSecrets"
slug: "org.OrgSecrets"
---

[org](../../modules/org).OrgSecrets
...
• **new OrgSecrets**(`__namedParameters?`)

#### Parameters

| Name                | Type                                          |
| :------------------ | :-------------------------------------------- |
| `__namedParameters` | `Partial`<[`OrgSecrets`](../org.OrgSecrets)\> |
...
[core/src/org.ts:148](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L148)
...
[core/src/org.ts:154](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L154)
...
[core/src/org.ts:157](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/org.ts#L157)
...
[[exlude]] array and calls [toRaw](org.OrgSecrets.md#toraw) on any properties
...
▸ **clone**(): [`OrgSecrets`](../org.OrgSecrets)
...
▸ **fromBytes**(`bytes`): [`OrgSecrets`](../org.OrgSecrets)
...
▸ **fromJSON**(`json`): [`OrgSecrets`](../org.OrgSecrets)
...
▸ **fromRaw**(`raw`): [`OrgSecrets`](../org.OrgSecrets)

Restores propertiers from a raw object of the same form generated by
[toRaw](org.OrgSecrets.md#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](org.OrgSecrets.md#_fromraw) method to
...
versions. Use [\_toRaw](org.OrgSecrets.md#_toraw) for subclass-specific
behavior.
