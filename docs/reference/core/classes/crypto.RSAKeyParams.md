...
[[exlude]] array and calls [toRaw](../crypto.RSAKeyParams#toraw) on any
...
[toRaw](../crypto.RSAKeyParams#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../crypto.RSAKeyParams#_fromraw) method
...
versions. Use [\_toRaw](../crypto.RSAKeyParams#_toraw) for subclass-specific
behavior.
