...
slug: "quota.AccountQuota"
---

[quota](../../modules/quota).AccountQuota
...
| Name    | Type                                                |
| :------ | :-------------------------------------------------- |
| `vals?` | `Partial`<[`AccountQuota`](../quota.AccountQuota)\> |
...
[core/src/quota.ts:8](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L8)
...
[core/src/quota.ts:4](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L4)
...
[core/src/quota.ts:6](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L6)
...
[core/src/quota.ts:5](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L5)
...
[[exlude]] array and calls [toRaw](quota.AccountQuota.md#toraw) on any
...
▸ **clone**(): [`AccountQuota`](../quota.AccountQuota)
...
▸ **fromBytes**(`bytes`): [`AccountQuota`](../quota.AccountQuota)
...
▸ **fromJSON**(`json`): [`AccountQuota`](../quota.AccountQuota)
...
▸ **fromRaw**(`raw`): [`AccountQuota`](../quota.AccountQuota)

Restores propertiers from a raw object of the same form generated by
[toRaw](quota.AccountQuota.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](quota.AccountQuota.md#_fromraw) method to
...
versions. Use [\_toRaw](quota.AccountQuota.md#_toraw) for subclass-specific
behavior.
