...
[[exlude]] array and calls [toRaw](../quota.AccountQuota#toraw) on any
...
[toRaw](../quota.AccountQuota#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../quota.AccountQuota#_fromraw) method to
...
versions. Use [\_toRaw](../quota.AccountQuota#_toraw) for subclass-specific
behavior.
