...
[toRaw](api.CompleteRegisterMFAuthenticatorResponse.md#toraw) on any properties
...
[toRaw](api.CompleteRegisterMFAuthenticatorResponse.md#toraw). The base
...
[\_fromRaw](api.CompleteRegisterMFAuthenticatorResponse.md#_fromraw) method to
...
versions. Use [\_toRaw](api.CompleteRegisterMFAuthenticatorResponse.md#_toraw)
