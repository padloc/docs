...
[[exlude]] array and calls [toRaw](../auth.AuthenticatorInfo#toraw) on any
...
[toRaw](../auth.AuthenticatorInfo#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../auth.AuthenticatorInfo#_fromraw)
...
versions. Use [\_toRaw](../auth.AuthenticatorInfo#_toraw) for subclass-specific
behavior.
