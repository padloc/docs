...
| Name    | Type                                        |
| :------ | :------------------------------------------ |
| `vals?` | `Partial`<[`OrgQuota`](../quota.OrgQuota)\> |
...
[core/src/quota.ts:22](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L22)
...
[core/src/quota.ts:18](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L18)
...
[core/src/quota.ts:17](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L17)
...
[core/src/quota.ts:20](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L20)
...
[core/src/quota.ts:19](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/quota.ts#L19)
...
[[exlude]] array and calls [toRaw](quota.OrgQuota.md#toraw) on any properties
...
▸ **fromBytes**(`bytes`): [`OrgQuota`](../quota.OrgQuota)
...
▸ **fromJSON**(`json`): [`OrgQuota`](../quota.OrgQuota)
...
▸ **fromRaw**(`raw`): [`OrgQuota`](../quota.OrgQuota)

Restores propertiers from a raw object of the same form generated by
[toRaw](quota.OrgQuota.md#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](quota.OrgQuota.md#_fromraw) method to
...
versions. Use [\_toRaw](quota.OrgQuota.md#_toraw) for subclass-specific
behavior.
