...
[[exlude]] array and calls [toRaw](../quota.OrgQuota#toraw) on any properties
...
[toRaw](../quota.OrgQuota#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../quota.OrgQuota#_fromraw) method to
...
versions. Use [\_toRaw](../quota.OrgQuota#_toraw) for subclass-specific
behavior.
