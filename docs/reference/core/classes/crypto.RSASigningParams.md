...
[[exlude]] array and calls [toRaw](../crypto.RSASigningParams#toraw) on any
...
[toRaw](../crypto.RSASigningParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../crypto.RSASigningParams#_fromraw)
...
versions. Use [\_toRaw](../crypto.RSASigningParams#_toraw) for subclass-specific
behavior.
