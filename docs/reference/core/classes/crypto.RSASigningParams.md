---
title: "Class: RSASigningParams"
linkTitle: "RSASigningParams"
slug: "crypto.RSASigningParams"
---

[crypto](../../modules/crypto).RSASigningParams
...
[core/src/crypto.ts:106](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L106)
...
[core/src/crypto.ts:107](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L107)
...
[core/src/crypto.ts:108](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L108)
...
[[exlude]] array and calls [toRaw](crypto.RSASigningParams.md#toraw) on any
...
▸ **clone**(): [`RSASigningParams`](../crypto.RSASigningParams)
...
▸ **fromBytes**(`bytes`): [`RSASigningParams`](../crypto.RSASigningParams)
...
▸ **fromJSON**(`json`): [`RSASigningParams`](../crypto.RSASigningParams)
...
▸ **fromRaw**(`raw`): [`RSASigningParams`](../crypto.RSASigningParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](crypto.RSASigningParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](crypto.RSASigningParams.md#_fromraw)
...
versions. Use [\_toRaw](crypto.RSASigningParams.md#_toraw) for subclass-specific
behavior.
...
[core/src/crypto.ts:110](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L110)
