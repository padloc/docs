...
[[exlude]] array and calls [toRaw](../org.ScimSettings#toraw) on any properties
...
[toRaw](../org.ScimSettings#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../org.ScimSettings#_fromraw) method to
...
versions. Use [\_toRaw](../org.ScimSettings#_toraw) for subclass-specific
behavior.
