...
The [privateKey](../account.Account#privatekey) and
[signingKey](../account.Account#signingkey) properties are considered secret and
...
[PBES2Container](../container.PBES2Container).[constructor](../container.PBES2Container#constructor)
...
[unlock](../account.Account#unlock) method.

#### Inherited from

[PBES2Container](../container.PBES2Container).[\_key](../container.PBES2Container#_key)
...
[PBES2Container](../container.PBES2Container).[\_propertySerializationOptions](../container.PBES2Container#_propertyserializationoptions)
...
[PBES2Container](../container.PBES2Container).[encryptedData](../container.PBES2Container#encrypteddata)
...
[PBES2Container](../container.PBES2Container).[encryptionParams](../container.PBES2Container#encryptionparams)
...
[PBES2Container](../container.PBES2Container).[keyParams](../container.PBES2Container#keyparams)
...
[PBES2Container](../container.PBES2Container).[\_fromRaw](../container.PBES2Container#_fromraw)
...
[[exlude]] array and calls [toRaw](../account.Account#toraw) on any properties
...
[PBES2Container](../container.PBES2Container).[\_toRaw](../container.PBES2Container#_toraw)
...
[PBES2Container](../container.PBES2Container).[clone](../container.PBES2Container#clone)
...
[PBES2Container](../container.PBES2Container).[fromBytes](../container.PBES2Container#frombytes)
...
[PBES2Container](../container.PBES2Container).[fromJSON](../container.PBES2Container#fromjson)
...
[toRaw](../account.Account#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../account.Account#_fromraw) method to
...
[PBES2Container](../container.PBES2Container).[fromRaw](../container.PBES2Container#fromraw)
...
[PBES2Container](../container.PBES2Container).[getData](../container.PBES2Container#getdata)
...
Generates the accounts [privateKey](../account.Account#privatekey),
[publicKey](../account.Account#publickey) and
[signingKey](../account.Account#signingkey) and encrypts
[privateKey](../account.Account#privatekey) and [[singingKey]] using the master
password.
...
[PBES2Container](../container.PBES2Container).[lock](../container.PBES2Container#lock)
...
[PBES2Container](../container.PBES2Container).[setData](../container.PBES2Container#setdata)
...
[privateKey](../account.Account#privatekey) and
[signingKey](../account.Account#signingkey) properties
...
[PBES2Container](../container.PBES2Container).[toBytes](../container.PBES2Container#tobytes)
...
[PBES2Container](../container.PBES2Container).[toJSON](../container.PBES2Container#tojson)
...
versions. Use [\_toRaw](../account.Account#_toraw) for subclass-specific
behavior.
...
[PBES2Container](../container.PBES2Container).[toRaw](../container.PBES2Container#toraw)
...
[privateKey](../account.Account#privatekey) and
[signingKey](../account.Account#signingkey) from
[encryptedData](../account.Account#encrypteddata)
...
[PBES2Container](../container.PBES2Container).[unlock](../container.PBES2Container#unlock)
...
[PBES2Container](../container.PBES2Container).[validate](../container.PBES2Container#validate)
