...
[[exlude]] array and calls [toRaw](../item.VaultItem#toraw) on any properties
...
[toRaw](../item.VaultItem#toraw). The base implementation blindly copies over
...
version. Use the protected [\_fromRaw](../item.VaultItem#_fromraw) method to
...
versions. Use [\_toRaw](../item.VaultItem#_toraw) for subclass-specific
behavior.
