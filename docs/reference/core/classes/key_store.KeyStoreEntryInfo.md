...
[[exlude]] array and calls [toRaw](../key_store.KeyStoreEntryInfo#toraw) on any
...
[toRaw](../key_store.KeyStoreEntryInfo#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../key_store.KeyStoreEntryInfo#_fromraw)
...
versions. Use [\_toRaw](../key_store.KeyStoreEntryInfo#_toraw) for
