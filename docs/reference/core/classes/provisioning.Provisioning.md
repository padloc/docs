...
[[exlude]] array and calls [toRaw](../provisioning.Provisioning#toraw) on any
...
[toRaw](../provisioning.Provisioning#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../provisioning.Provisioning#_fromraw)
...
versions. Use [\_toRaw](../provisioning.Provisioning#_toraw) for
