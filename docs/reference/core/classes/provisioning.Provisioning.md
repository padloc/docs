---
title: "Class: Provisioning"
linkTitle: "Provisioning"
slug: "provisioning.Provisioning"
---

[provisioning](../../modules/provisioning).Provisioning
...
• **new Provisioning**(`vals?`)

#### Parameters

| Name   | Type                                                       |
| :----- | :--------------------------------------------------------- |
| `vals` | `Partial`<[`Provisioning`](../provisioning.Provisioning)\> |
...
[core/src/provisioning.ts:193](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L193)
...
• **account**: [`AccountProvisioning`](../provisioning.AccountProvisioning)

#### Defined in

[core/src/provisioning.ts:199](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L199)

---

### orgs

• **orgs**: [`OrgProvisioning`](../provisioning.OrgProvisioning)[] = `[]`

#### Defined in

[core/src/provisioning.ts:202](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/provisioning.ts#L202)
...
[[exlude]] array and calls [toRaw](provisioning.Provisioning.md#toraw) on any
...
▸ **clone**(): [`Provisioning`](../provisioning.Provisioning)
...
▸ **fromBytes**(`bytes`): [`Provisioning`](../provisioning.Provisioning)
...
▸ **fromJSON**(`json`): [`Provisioning`](../provisioning.Provisioning)
...
▸ **fromRaw**(`raw`): [`Provisioning`](../provisioning.Provisioning)

Restores propertiers from a raw object of the same form generated by
[toRaw](provisioning.Provisioning.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](provisioning.Provisioning.md#_fromraw)
...
versions. Use [\_toRaw](provisioning.Provisioning.md#_toraw) for
