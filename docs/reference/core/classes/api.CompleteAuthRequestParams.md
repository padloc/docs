---
title: "Class: CompleteAuthRequestParams"
linkTitle: "CompleteAuthRequestParams"
slug: "api.CompleteAuthRequestParams"
---

[api](../../modules/api).CompleteAuthRequestParams
...
• **new CompleteAuthRequestParams**(`props?`)

#### Parameters

| Name     | Type                                                                        |
| :------- | :-------------------------------------------------------------------------- |
| `props?` | `Partial`<[`CompleteAuthRequestParams`](../api.CompleteAuthRequestParams)\> |
...
[core/src/api.ts:189](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L189)
...
[core/src/api.ts:187](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L187)
...
[core/src/api.ts:183](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L183)
...
[core/src/api.ts:185](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L185)
...
[[exlude]] array and calls [toRaw](api.CompleteAuthRequestParams.md#toraw) on
...
▸ **clone**(): [`CompleteAuthRequestParams`](../api.CompleteAuthRequestParams)
...
[toRaw](api.CompleteAuthRequestParams.md#toraw). The base implementation blindly
...
[\_fromRaw](api.CompleteAuthRequestParams.md#_fromraw) method to implement
...
versions. Use [\_toRaw](api.CompleteAuthRequestParams.md#_toraw) for
subclass-specific behavior.
