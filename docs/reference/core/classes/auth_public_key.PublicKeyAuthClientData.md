...
[unlock](../auth_public_key.PublicKeyAuthClientData#unlock) method.
...
[toRaw](../auth_public_key.PublicKeyAuthClientData#toraw) on any properties that
...
[toRaw](../auth_public_key.PublicKeyAuthClientData#toraw). The base
...
[\_fromRaw](../auth_public_key.PublicKeyAuthClientData#_fromraw) method to
...
[getData](../auth_public_key.PublicKeyAuthClientData#getdata) until the
...
versions. Use [\_toRaw](../auth_public_key.PublicKeyAuthClientData#_toraw) for
...
[getData](../auth_public_key.PublicKeyAuthClientData#getdata). The type of
