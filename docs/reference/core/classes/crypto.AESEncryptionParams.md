...
[[exlude]] array and calls [toRaw](../crypto.AESEncryptionParams#toraw) on any
...
[toRaw](../crypto.AESEncryptionParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../crypto.AESEncryptionParams#_fromraw)
...
versions. Use [\_toRaw](../crypto.AESEncryptionParams#_toraw) for
