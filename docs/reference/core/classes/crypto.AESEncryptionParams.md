---
title: "Class: AESEncryptionParams"
linkTitle: "AESEncryptionParams"
slug: "crypto.AESEncryptionParams"
---

[crypto](../../modules/crypto).AESEncryptionParams
...
[core/src/crypto.ts:23](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L23)
...
[core/src/crypto.ts:15](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L15)
...
[core/src/crypto.ts:20](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L20)
...
[core/src/crypto.ts:17](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L17)
...
[core/src/crypto.ts:16](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L16)
...
[[exlude]] array and calls [toRaw](crypto.AESEncryptionParams.md#toraw) on any
...
▸ **clone**(): [`AESEncryptionParams`](../crypto.AESEncryptionParams)
...
▸ **fromBytes**(`bytes`): [`AESEncryptionParams`](../crypto.AESEncryptionParams)
...
▸ **fromJSON**(`json`): [`AESEncryptionParams`](../crypto.AESEncryptionParams)
...
▸ **fromRaw**(`raw`): [`AESEncryptionParams`](../crypto.AESEncryptionParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](crypto.AESEncryptionParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](crypto.AESEncryptionParams.md#_fromraw)
...
versions. Use [\_toRaw](crypto.AESEncryptionParams.md#_toraw) for
...
[core/src/crypto.ts:25](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/crypto.ts#L25)
