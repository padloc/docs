...
[[exlude]] array and calls [toRaw](../api.CompleteAuthRequestResponse#toraw) on
...
[toRaw](../api.CompleteAuthRequestResponse#toraw). The base implementation
...
[\_fromRaw](../api.CompleteAuthRequestResponse#_fromraw) method to implement
...
versions. Use [\_toRaw](../api.CompleteAuthRequestResponse#_toraw) for
subclass-specific behavior.
