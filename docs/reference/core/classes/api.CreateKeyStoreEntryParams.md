...
[[exlude]] array and calls [toRaw](../api.CreateKeyStoreEntryParams#toraw) on
...
[toRaw](../api.CreateKeyStoreEntryParams#toraw). The base implementation blindly
...
[\_fromRaw](../api.CreateKeyStoreEntryParams#_fromraw) method to implement
...
versions. Use [\_toRaw](../api.CreateKeyStoreEntryParams#_toraw) for
subclass-specific behavior.
