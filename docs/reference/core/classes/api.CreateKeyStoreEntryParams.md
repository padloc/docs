---
title: "Class: CreateKeyStoreEntryParams"
linkTitle: "CreateKeyStoreEntryParams"
slug: "api.CreateKeyStoreEntryParams"
---

[api](../../modules/api).CreateKeyStoreEntryParams
...
• **new CreateKeyStoreEntryParams**(`vals?`)

#### Parameters

| Name   | Type                                                                        |
| :----- | :-------------------------------------------------------------------------- |
| `vals` | `Partial`<[`CreateKeyStoreEntryParams`](../api.CreateKeyStoreEntryParams)\> |
...
[core/src/api.ts:324](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L324)
...
[core/src/api.ts:332](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L332)
...
[core/src/api.ts:330](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L330)
...
[[exlude]] array and calls [toRaw](api.CreateKeyStoreEntryParams.md#toraw) on
...
▸ **clone**(): [`CreateKeyStoreEntryParams`](../api.CreateKeyStoreEntryParams)
...
[toRaw](api.CreateKeyStoreEntryParams.md#toraw). The base implementation blindly
...
[\_fromRaw](api.CreateKeyStoreEntryParams.md#_fromraw) method to implement
...
versions. Use [\_toRaw](api.CreateKeyStoreEntryParams.md#_toraw) for
subclass-specific behavior.
