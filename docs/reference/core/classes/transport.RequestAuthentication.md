---
title: "Class: RequestAuthentication"
linkTitle: "RequestAuthentication"
slug: "transport.RequestAuthentication"
---

[transport](../../modules/transport).RequestAuthentication
...
• **new RequestAuthentication**(`vals?`)

#### Parameters

| Name   | Type                                                                      |
| :----- | :------------------------------------------------------------------------ |
| `vals` | `Partial`<[`RequestAuthentication`](../transport.RequestAuthentication)\> |
...
[core/src/transport.ts:20](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/transport.ts#L20)
...
The id of the [Session](../session.Session) used for authentication

#### Defined in

[core/src/transport.ts:10](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/transport.ts#L10)
...
[core/src/transport.ts:18](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/transport.ts#L18)
...
[core/src/transport.ts:14](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/transport.ts#L14)
...
[[exlude]] array and calls [toRaw](transport.RequestAuthentication.md#toraw) on
...
▸ **clone**(): [`RequestAuthentication`](../transport.RequestAuthentication)
...
[toRaw](transport.RequestAuthentication.md#toraw). The base implementation
...
[\_fromRaw](transport.RequestAuthentication.md#_fromraw) method to implement
...
versions. Use [\_toRaw](transport.RequestAuthentication.md#_toraw) for
subclass-specific behavior.
