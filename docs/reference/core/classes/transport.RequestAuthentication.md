...
[[exlude]] array and calls [toRaw](../transport.RequestAuthentication#toraw) on
...
[toRaw](../transport.RequestAuthentication#toraw). The base implementation
...
[\_fromRaw](../transport.RequestAuthentication#_fromraw) method to implement
...
versions. Use [\_toRaw](../transport.RequestAuthentication#_toraw) for
subclass-specific behavior.
