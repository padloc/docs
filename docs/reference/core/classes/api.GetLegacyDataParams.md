---
title: "Class: GetLegacyDataParams"
linkTitle: "GetLegacyDataParams"
slug: "api.GetLegacyDataParams"
---

[api](../../modules/api).GetLegacyDataParams
...
• **new GetLegacyDataParams**(`vals?`)

#### Parameters

| Name   | Type                                                            |
| :----- | :-------------------------------------------------------------- |
| `vals` | `Partial`<[`GetLegacyDataParams`](../api.GetLegacyDataParams)\> |
...
[core/src/api.ts:314](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L314)
...
[core/src/api.ts:319](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L319)
...
[core/src/api.ts:320](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L320)
...
[[exlude]] array and calls [toRaw](api.GetLegacyDataParams.md#toraw) on any
...
▸ **clone**(): [`GetLegacyDataParams`](../api.GetLegacyDataParams)
...
▸ **fromBytes**(`bytes`): [`GetLegacyDataParams`](../api.GetLegacyDataParams)
...
▸ **fromJSON**(`json`): [`GetLegacyDataParams`](../api.GetLegacyDataParams)
...
▸ **fromRaw**(`raw`): [`GetLegacyDataParams`](../api.GetLegacyDataParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](api.GetLegacyDataParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](api.GetLegacyDataParams.md#_fromraw)
...
versions. Use [\_toRaw](api.GetLegacyDataParams.md#_toraw) for subclass-specific
behavior.
