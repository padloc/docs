...
[[exlude]] array and calls [toRaw](../api.GetLegacyDataParams#toraw) on any
...
[toRaw](../api.GetLegacyDataParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.GetLegacyDataParams#_fromraw)
...
versions. Use [\_toRaw](../api.GetLegacyDataParams#_toraw) for subclass-specific
behavior.
