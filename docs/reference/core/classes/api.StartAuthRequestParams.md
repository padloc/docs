...
[[exlude]] array and calls [toRaw](../api.StartAuthRequestParams#toraw) on any
...
[toRaw](../api.StartAuthRequestParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.StartAuthRequestParams#_fromraw)
...
versions. Use [\_toRaw](../api.StartAuthRequestParams#_toraw) for
