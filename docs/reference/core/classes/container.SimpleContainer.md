...
[unlock](../container.SimpleContainer#unlock) method.
...
[[exlude]] array and calls [toRaw](../container.SimpleContainer#toraw) on any
...
[toRaw](../container.SimpleContainer#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../container.SimpleContainer#_fromraw)
...
[getData](../container.SimpleContainer#getdata) until the container is unlocked
...
versions. Use [\_toRaw](../container.SimpleContainer#_toraw) for
...
[getData](../container.SimpleContainer#getdata). The type of **secret** provided
