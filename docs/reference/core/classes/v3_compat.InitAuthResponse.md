---
title: "Class: InitAuthResponse"
linkTitle: "InitAuthResponse"
slug: "v3_compat.InitAuthResponse"
---

[v3-compat](../../modules/v3_compat).InitAuthResponse
...
• **new InitAuthResponse**(`props?`)

#### Parameters

| Name     | Type                                                            |
| :------- | :-------------------------------------------------------------- |
| `props?` | `Partial`<[`InitAuthResponse`](../v3_compat.InitAuthResponse)\> |
...
[core/src/v3-compat.ts:134](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L134)
...
[core/src/v3-compat.ts:132](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L132)
...
[core/src/v3-compat.ts:124](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L124)
...
[core/src/v3-compat.ts:128](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L128)
...
[[exlude]] array and calls [toRaw](../v3_compat.InitAuthResponse#toraw) on any
...
▸ **clone**(): [`InitAuthResponse`](../v3_compat.InitAuthResponse)
...
▸ **fromBytes**(`bytes`): [`InitAuthResponse`](../v3_compat.InitAuthResponse)
...
▸ **fromJSON**(`json`): [`InitAuthResponse`](../v3_compat.InitAuthResponse)
...
▸ **fromRaw**(`raw`): [`InitAuthResponse`](../v3_compat.InitAuthResponse)

Restores propertiers from a raw object of the same form generated by
[toRaw](../v3_compat.InitAuthResponse#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../v3_compat.InitAuthResponse#_fromraw)
...
versions. Use [\_toRaw](../v3_compat.InitAuthResponse#_toraw) for
