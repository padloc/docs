...
[[exlude]] array and calls [toRaw](../v3_compat.InitAuthParams#toraw) on any
...
[toRaw](../v3_compat.InitAuthParams#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../v3_compat.InitAuthParams#_fromraw)
...
versions. Use [\_toRaw](../v3_compat.InitAuthParams#_toraw) for
