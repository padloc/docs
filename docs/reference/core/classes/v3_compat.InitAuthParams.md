---
title: "Class: InitAuthParams"
linkTitle: "InitAuthParams"
slug: "v3_compat.InitAuthParams"
---

[v3-compat](../../modules/v3_compat).InitAuthParams
...
• **new InitAuthParams**(`props?`)

#### Parameters

| Name     | Type                                                        |
| :------- | :---------------------------------------------------------- |
| `props?` | `Partial`<[`InitAuthParams`](../v3_compat.InitAuthParams)\> |
...
[core/src/v3-compat.ts:112](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L112)
...
The email address of the [Account](../account.Account) in question

#### Defined in

[core/src/v3-compat.ts:105](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L105)

---

### verify

• `Optional` **verify**: `string` = `undefined`

The verification token obtained from [[API.completeEmailVerification]].

#### Defined in

[core/src/v3-compat.ts:110](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/v3-compat.ts#L110)
...
[[exlude]] array and calls [toRaw](v3_compat.InitAuthParams.md#toraw) on any
...
▸ **clone**(): [`InitAuthParams`](../v3_compat.InitAuthParams)
...
▸ **fromBytes**(`bytes`): [`InitAuthParams`](../v3_compat.InitAuthParams)
...
▸ **fromJSON**(`json`): [`InitAuthParams`](../v3_compat.InitAuthParams)
...
▸ **fromRaw**(`raw`): [`InitAuthParams`](../v3_compat.InitAuthParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](v3_compat.InitAuthParams.md#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](v3_compat.InitAuthParams.md#_fromraw)
...
versions. Use [\_toRaw](v3_compat.InitAuthParams.md#_toraw) for
