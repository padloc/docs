...
[[exlude]] array and calls [toRaw](../api.StartAuthRequestResponse#toraw) on any
...
[toRaw](../api.StartAuthRequestResponse#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../api.StartAuthRequestResponse#_fromraw)
...
versions. Use [\_toRaw](../api.StartAuthRequestResponse#_toraw) for
