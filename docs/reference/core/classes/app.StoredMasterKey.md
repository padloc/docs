...
[unlock](app.StoredMasterKey.md#unlock) method.
...
[[exlude]] array and calls [toRaw](app.StoredMasterKey.md#toraw) on any
...
[toRaw](app.StoredMasterKey.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](app.StoredMasterKey.md#_fromraw) method
...
[getData](app.StoredMasterKey.md#getdata) until the container is unlocked again.
...
versions. Use [\_toRaw](app.StoredMasterKey.md#_toraw) for subclass-specific
behavior.
...
[getData](app.StoredMasterKey.md#getdata). The type of **secret** provided will
