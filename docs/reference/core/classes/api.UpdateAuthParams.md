...
[[exlude]] array and calls [toRaw](../api.UpdateAuthParams#toraw) on any
...
[toRaw](../api.UpdateAuthParams#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](../api.UpdateAuthParams#_fromraw) method
...
versions. Use [\_toRaw](../api.UpdateAuthParams#_toraw) for subclass-specific
behavior.
