---
title: "Class: UpdateAuthParams"
linkTitle: "UpdateAuthParams"
slug: "api.UpdateAuthParams"
---

[api](../../modules/api).UpdateAuthParams
...
• **new UpdateAuthParams**(`vals?`)

#### Parameters

| Name   | Type                                                      |
| :----- | :-------------------------------------------------------- |
| `vals` | `Partial`<[`UpdateAuthParams`](../api.UpdateAuthParams)\> |
...
[core/src/api.ts:377](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L377)
...
• `Optional` **keyParams**: [`PBKDF2Params`](../crypto.PBKDF2Params)
...
[core/src/api.ts:391](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L391)

---

### mfaOrder

• `Optional` **mfaOrder**: `string`[] = `undefined`

#### Defined in

[core/src/api.ts:393](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L393)
...
[core/src/api.ts:384](https://github.com/padloc/padloc/blob/b00eb4fd/packages/core/src/api.ts#L384)
...
[[exlude]] array and calls [toRaw](api.UpdateAuthParams.md#toraw) on any
...
▸ **clone**(): [`UpdateAuthParams`](../api.UpdateAuthParams)
...
▸ **fromBytes**(`bytes`): [`UpdateAuthParams`](../api.UpdateAuthParams)
...
▸ **fromJSON**(`json`): [`UpdateAuthParams`](../api.UpdateAuthParams)
...
▸ **fromRaw**(`raw`): [`UpdateAuthParams`](../api.UpdateAuthParams)

Restores propertiers from a raw object of the same form generated by
[toRaw](api.UpdateAuthParams.md#toraw). The base implementation blindly copies
...
version. Use the protected [\_fromRaw](api.UpdateAuthParams.md#_fromraw) method
...
versions. Use [\_toRaw](api.UpdateAuthParams.md#_toraw) for subclass-specific
behavior.
