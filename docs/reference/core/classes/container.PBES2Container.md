...
[unlock](../container.PBES2Container#unlock) method.
...
[[exlude]] array and calls [toRaw](../container.PBES2Container#toraw) on any
...
[toRaw](../container.PBES2Container#toraw). The base implementation blindly
...
version. Use the protected [\_fromRaw](../container.PBES2Container#_fromraw)
...
[getData](../container.PBES2Container#getdata) until the container is unlocked
...
versions. Use [\_toRaw](../container.PBES2Container#_toraw) for
